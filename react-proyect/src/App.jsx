    ...
    <>
      ...
      <div className="App">
        <CardImage
          ...
          alt="
6 orange background tulips"
          url="https://cdn.pixabay.com/photo/2022/08/01/10/36/tulips-7357877_1280.jpg"
          title="Tulipanes rojos en primavera"
        />
        <CardImage
          button={descriptionButton}
          alt="
blue rose with dew"
          url="https://cdn.pixabay.com/photo/2013/07/21/13/00/rose-165819_1280.jpg"
          title="Rosa azul con rocío"
        />
        <CardImage
          button={descriptionButton}
          alt="
beautiful blue and pink rose with dew"
          url="https://cdn.pixabay.com/photo/2015/04/19/08/32/rose-729509_1280.jpg"
          title="Rosa de varios colores con rocío"
        />
        <Alert variant="success">Imágenes extraídas de pixabay!</Alert>
      </div>
